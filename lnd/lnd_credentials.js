  ...
  return new Promise((resolve, reject) => {
    return asyncAuto({
      ...
      getCert: ['forNode', ({forNode}, cbk) => {
        return getCert({fs, os, lnDir: args.lnDir, node: forNode}, cbk);
      }],

      // Get the default macaroon
      getMacaroon: ['forNode', ({forNode}, cbk) => {
        return getMacaroon({fs, os, lnDir: args.lnDir, node: forNode}, cbk);
      }],
      ...
      getSocket: ['forNode', ({forNode}, cbk) => {
        ...
        return getSocket({fs, os,lnDir: args.lnDir, node: forNode}, cbk);
      }],
